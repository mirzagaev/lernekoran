    ...
    <div className="Dashboard bg-gray-100 h-screen flex ">
      <aside className="flex">
          <div className="flex flex-col items-center w-16 h-screen py-8 space-y-8 bg-white">
            <a href="https://lerne-koran.de" className="flex items-center justify-center rounded-md bg-white px-4 text-blue-600">
              ...
              <button className="p-1.5 text-blue-500 transition-colors duration-200 bg-blue-100 rounded-lg">
          ...
          <div className="h-screen py-8 overflow-y-auto bg-white border-l border-r sm:w-64 w-60">
              <h2 className="px-5 text-lg font-medium text-gray-800">Lerne-Koran.de</h2>
              <div className="mt-8 px-5">
                  <div className="font-medium text-gray-700 capitalize">{user.attributes.name} {user.attributes.family_name}</div>
              ...
              <div className="mt-5 px-5 text-sm text-gray-500">{user.attributes.email}</div>
              <div className="mt-5 px-5 text-sm text-gray-500">{user.attributes.birthdate}</div>
          </div>
      ...
      <main className="main -ml-48 flex flex-grow flex-col p-8 transition-all duration-150 ease-in md:ml-0">
        <div className="flex h-full bg-white px-12 py-8 shadow-md">
